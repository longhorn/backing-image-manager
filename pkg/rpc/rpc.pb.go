...
func (m *CleanUpOrphanRequest) Reset()         { *m = CleanUpOrphanRequest{} }
func (m *CleanUpOrphanRequest) String() string { return proto.CompactTextString(m) }
func (*CleanUpOrphanRequest) ProtoMessage()    {}
func (*CleanUpOrphanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{12}
}

func (m *CleanUpOrphanRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CleanUpOrphanRequest.Unmarshal(m, b)
}
func (m *CleanUpOrphanRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CleanUpOrphanRequest.Marshal(b, m, deterministic)
}
func (m *CleanUpOrphanRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CleanUpOrphanRequest.Merge(m, src)
}
func (m *CleanUpOrphanRequest) XXX_Size() int {
	return xxx_messageInfo_CleanUpOrphanRequest.Size(m)
}
func (m *CleanUpOrphanRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_CleanUpOrphanRequest.DiscardUnknown(m)
}

var xxx_messageInfo_CleanUpOrphanRequest proto.InternalMessageInfo

func (m *CleanUpOrphanRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *CleanUpOrphanRequest) GetUuid() string {
	if m != nil {
		return m.Uuid
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*CleanUpOrphanRequest)(nil), "longhorn.backingimagemanager.pkg.rpc.CleanUpOrphanRequest")
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type BackingImageManagerServiceClient interface {
	...
	CleanUpOrphan(ctx context.Context, in *CleanUpOrphanRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *backingImageManagerServiceClient) CleanUpOrphan(ctx context.Context, in *CleanUpOrphanRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/longhorn.backingimagemanager.pkg.rpc.BackingImageManagerService/CleanUpOrphan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackingImageManagerServiceServer interface {
	...
	CleanUpOrphan(context.Context, *CleanUpOrphanRequest) (*empty.Empty, error)
...
func (*UnimplementedBackingImageManagerServiceServer) CleanUpOrphan(ctx context.Context, req *CleanUpOrphanRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CleanUpOrphan not implemented")
}
...
func _BackingImageManagerService_CleanUpOrphan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CleanUpOrphanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackingImageManagerServiceServer).CleanUpOrphan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/longhorn.backingimagemanager.pkg.rpc.BackingImageManagerService/CleanUpOrphan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackingImageManagerServiceServer).CleanUpOrphan(ctx, req.(*CleanUpOrphanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BackingImageManagerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CleanUpOrphan",
			Handler:    _BackingImageManagerService_CleanUpOrphan_Handler,
		},
	},
