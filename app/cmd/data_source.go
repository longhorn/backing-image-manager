...
func dataSource(c *cli.Command) error {
	...
	return datasource.NewServer(context.Background(), listen, syncListen, ipFamily, checksum, sourceType, name, uuid, types.DiskPathInContainer, parameters, credential, &sync.HTTPHandler{})
}
